...
--
-- Name: games_opponent_id_idx; Type: INDEX; Schema: public; Owner: freecodecamp
--

CREATE INDEX games_opponent_id_idx ON public.games USING btree (opponent_id);


--
-- Name: games_winner_id_idx; Type: INDEX; Schema: public; Owner: freecodecamp
--

CREATE INDEX games_winner_id_idx ON public.games USING btree (winner_id);
